...
namespace SmartB.Core.Controls
{
    ...
    public partial class JobInformation : ContentView
    {
        ...
        {
            var control = (JobInformation)bindable;
        ...
        public static readonly BindableProperty EmployeeProperty = BindableProperty.Create(
            propertyName: "Employee", returnType: typeof(string), declaringType: typeof(JobInformation),
        ...
        public static readonly BindableProperty SectorProperty = BindableProperty.Create(
            propertyName: "Sector", returnType: typeof(string), declaringType: typeof(JobInformation),
        ...
        public static readonly BindableProperty CommessaProperty = BindableProperty.Create(
            propertyName: "Commessa", returnType: typeof(string), declaringType: typeof(JobInformation),
        ...
        public static readonly BindableProperty PhaseProperty = BindableProperty.Create(
            propertyName: "Phase", returnType: typeof(string), declaringType: typeof(JobInformation),
        ...
        public static readonly BindableProperty MachineProperty = BindableProperty.Create(
            propertyName: "Machine", returnType: typeof(string), declaringType: typeof(JobInformation),
